...
/**
 * 		\defgroup   modETransactions     Module ETransactions
 *      \file       htdocs/core/modules/modETransactions.class.php
 *      \ingroup    modETransactions
 *      \brief      Description and activation file for module modETransactions
 */
include_once(DOL_DOCUMENT_ROOT ."/core/modules/DolibarrModules.class.php");


/**
 * 		\class      modETransactions
 *      \brief      Description and activation class for module modETransactions
 */
class modETransactions extends DolibarrModules
{
	/**
	...
	function __construct($db)
	{
		...
		$this->rights_class = 'etransactions';
		...
		$this->description = "Module de paiement par carte de crédit avec la solution de paiement ETransactions";
		...
		$this->config_page_url = array('config.php@etransactions');
		...
		$this->langfiles = array("etransactions@etransactions");
        ...
        $this->rights[$r][0] = 770001; 				// Permission id (must not be already used)
        ...
        $this->rights[$r][0] = 770002; 				// Permission id (must not be already used)
        ...
        $this->rights[$r][0] = 770003; 				// Permission id (must not be already used)
        ...
        $this->rights[$r][0] = 770004; 				// Permission id (must not be already used)
        ...
        $this->rights[$r][0] = 770005; 				// Permission id (must not be already used)
	...
	{
		return $this->_load_tables('/etransactions/sql/');
	}
}
