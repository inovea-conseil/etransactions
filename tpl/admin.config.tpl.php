...
llxHeader('', $langs->trans('ETransactionsAdmin'));

echo ($message ? dol_htmloutput_mesg($message, '', ($error ? 'error' : 'ok'), 0) : '');

print_fiche_titre($langs->trans('ETransactionsAdmin'), $linkback, 'setup');
...
<br />
<?php echo $langs->trans("ETransactionsDesc"); ?>
<br />
...
<tr class="impair">
    ...
    <td><?php $api_key_editor->create(); ?></td>
